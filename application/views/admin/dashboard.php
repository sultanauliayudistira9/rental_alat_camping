...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; font-family: Arial, sans-serif; }
        ...
        .menu a { display: inline-block; color: #fff; padding: 12px 20px; border-radius: 5px; text-decoration: none; margin-right: 10px; }
        .menu-alat { background: #27ae60; }
        .menu-transaksi { background: #e67e22; }
    </style>
</head>
<body>
    <div class="topbar">
    ...
    <div class="content">
        <div class="card">
            ...
            <p>Ini dashboard admin. Pilih menu di bawah:</p>
            <div class="menu">
                <a href="<?= base_url('index.php/admin/alat') ?>" class="menu-alat">Kelola Alat</a>
                <a href="<?= base_url('index.php/admin/transaksi') ?>" class="menu-transaksi">Kelola Transaksi</a>
            </div>
        </div>
    </div>
</body>
